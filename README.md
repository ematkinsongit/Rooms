...
1. Enter the `authDomain`, `apiKey`, and `projectId` into `env.local` to their respective variables
1. `yarn dev`
...
Update your progress by checking off the tasks for each sprint.
